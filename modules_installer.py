...
def installPackage():
    ...
    os.system('start /B start cmd.exe @cmd /c  ' + installPythonPackage)
    print(entry1.get())
...
def uninstallPackage():
    ...
    os.system('start /B start cmd.exe @cmd /c ' + uninstallPythonPackage)
...
button2 = tk.Button(text='   Uninstall Package  ', command=uninstallPackage, bg='coral3', fg='white',
                    font=('helvetica', 12, 'bold'))
